...
void SolveSumProblem(const SimpleArray2D &array) {
    Solver solver("array sum problem");
    ...
    solver.AddConstraint(solver.MakeGreater(sum_var, 55));
    //solver.AddConstraint(solver.MakeBetweenCt(sum_var, 5, 10));
